...
_DEFAULT_SYSTEM_PROMPT = (
    ...
    "  CAPTCHAs, first call computer.focus_window with title='Chrome' to ensure "
    "  the browser is in the foreground, then use computer.mouse_drag to perform "
    ...
    "  puzzle piece to align with the gap in the background image. Focus the "
    "  Chrome window first, then use computer.mouse_drag with accurate screen "
    "  coordinates derived from the screenshot. The drag handle is around y=550 "
