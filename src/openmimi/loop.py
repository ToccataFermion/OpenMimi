...
_DEFAULT_SYSTEM_PROMPT = (
    ...
    "- Use action='is_visible' with ref or target_text to check if an element is present "
    "  and visible (not hidden by display:none, visibility:hidden, or zero size).\n"
    ...
    "- agent_browser get_attribute ref|target_text attribute_name: read a DOM attribute (href, src, data-id, etc.).\n"
    "- agent_browser set_attribute ref|target_text attribute_name attribute_value: write a DOM attribute.\n"
    "- agent_browser get_property ref|target_text property_name: read a JS property (value, checked, innerText, innerHTML).\n"
    ...
    "- agent_browser set_timezone: override browser timezone (e.g. 'Asia/Shanghai') via CDP. Pass empty string to reset.\n"
    "- agent_browser set_locale: override browser locale (e.g. 'zh-CN') via CDP. Pass empty string to reset.\n"
    "- agent_browser set_geolocation: override GPS location with latitude/longitude/accuracy via CDP. Omit coords to clear.\n"
