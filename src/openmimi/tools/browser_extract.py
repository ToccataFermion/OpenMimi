        ...
        return {
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "js_code": {"type": "string", "description": "Deprecated alias for 'js' (kept for back-compat); prefer 'js'."},
                    "js": {"type": "string", "description": "JavaScript code for eval. Wrap multi-line in IIFE."},
